...
class plugininfo extends plugin implements plugin_with_menuitems, plugin_with_buttons, plugin_with_configuration {
    ...
    public static function get_available_menuitems(): array {
        return [
            'tiny_accessibilityfontcolor/forecolor',
            'tiny_accessibilityfontcolor/backcolor',
        ];
    }
    ...
    public static function get_plugin_configuration_for_context(context $context, array $options, array $fpoptions,
        ...
        foreach (['textcolors', 'backgroundcolors'] as $configfield) {
            $data = json_decode(get_config('tiny_accessibilityfontcolor', $configfield), true);
            if (!\is_array($data)) {
                $data = [];
            }
            $array = [];
        ...
        $config['textcolorpicker'] = (bool)get_config('tiny_accessibilityfontcolor', 'textcolorpicker');
        $config['backgroundcolorpicker'] = (bool)get_config('tiny_accessibilityfontcolor', 'backgroundcolorpicker');
