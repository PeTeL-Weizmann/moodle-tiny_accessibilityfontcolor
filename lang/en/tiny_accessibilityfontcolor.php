...
$string['btnBgcolor'] = 'Background accessibilityfontcolor';
$string['btnFgcolor'] = 'Foreground accessibilityfontcolor';
...
$string['menuItemBgcolor'] = 'accessibilityfontcolor background';
$string['menuItemFgcolor'] = 'accessibilityfontcolor foreground';
$string['placeholdercolorname'] = 'Descriptive name of colour';
$string['placeholdercolorvalue'] = 'Hex code of colour value';
$string['pluginname'] = 'Tiny accessibility font colour';
...
$string['settings'] = 'Tiny accessibilityfontcolor settings';
